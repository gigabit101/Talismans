...
public class ContainerTalismanDuplicator extends Container {
    ...
    public ContainerTalismanDuplicator(InventoryPlayer inventoryPlayer, TileTalismanDuplicator tileTalismanDuplicator) {

        this.TileTalismanDuplicator = tileTalismanDuplicator;

        TileTalismanDuplicator.openChest();
        //todo fix
        this.addSlotToContainer(new Slot(tileTalismanDuplicator, TileTalismanDuplicator.INPUT_INVENTORY_INDEX, 30, 39));
        this.addSlotToContainer(new Slot(tileTalismanDuplicator, TileTalismanDuplicator.DUST_INVENTORY_INDEX, 48, 39));
 //       this.addSlotToContainer(new SlotTalismanDupeOutput(tileTalismanDuplicator, TileTalismanDuplicator.OUTPUT_INVENTORY_INDEX, 120, 39));
